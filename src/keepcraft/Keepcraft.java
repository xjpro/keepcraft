...
//		manager.registerEvents(new OutpostListener(userService, plotService, worldModifierService, chatService), this);
		manager.registerEvents(new ContainerListener(userService, containerService), this);
...
//		manager.registerEvents(new StatsListener(userService, plotService), this);
		...
		//manager.registerEvents(new CombatLogoffListener(userService), this);
		...
		// Admin commands
		AdminCommandListener adminCommandListener = new AdminCommandListener(userService, plotService, teamService, containerService, chatService);
		String[] adminCommands = {"promote", "demote", "delete", "setteam", "ptp", "dispense", "dawn", "noon", "dusk"};
