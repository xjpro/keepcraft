...
public abstract class ServerConditions 
{
    ...
    public static String getFactionName(int faction)
    {
        ...
        if(name == null)
        {
            switch(faction)
            {
                case UserFaction.FactionRed: return "Rho";
                case UserFaction.FactionBlue: return "Beta";
                case UserFaction.FactionGreen: return "Gamma";
                case UserFaction.FactionGold: return "Admin";
