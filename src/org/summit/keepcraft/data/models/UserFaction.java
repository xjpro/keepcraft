...
{	
	...
	public static ChatColor getChatColor(int faction)
	{
		switch(faction)
		{
		case FactionRed: return Chat.NameRed;
		case FactionBlue: return Chat.NameBlue;
        case FactionGreen: return Chat.NameGreen;
        case FactionGold: return Chat.NameGold;
		default: 		return Chat.NameOther;
		}
	}
