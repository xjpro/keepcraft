...
public abstract class DataCache 
{
	...
	/**
	 * In order for the cache to work, data must be loaded in before it's needed.
	 * @param type Type of object to cache
	 * @param key  Key of object
	 * @param pairedWorldObject An object from the game world that pairs with the database data
	 */
	...
	{			
		if(value instanceof User)
		{
            ...
            if(!exists(User.class, user.getName())) return false;
